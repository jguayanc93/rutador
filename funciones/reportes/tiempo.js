...
let verificar_tiempo = (req,res,next) =>{
...
let mostrar_tiempo = (req,res,next) =>{
...
let bd_consulta = (res,marca) =>{
    let sp_sql="select b.codf,b.descr,a.nomfam,b.Usr_001,ISNULL(dbo.API_TIEMPO_PRODUCTO(b.codi),0) from tbl01fam a inner join prd0101 b on (LEFT(b.codi,2)=a.codfam) left join prd0108 c on (c.codi=b.codi) where b.estado=1 AND b.marc=@marca";
...
module.exports={verificar_tiempo,mostrar_tiempo}