...
let verificar_stoc = (req,res,next) =>{
...
let mostrar_stock = (req,res,next) =>{
    ...
    let consulta = new Request(sp_sql,(err,rowCount,rows)=>{
        if(err){
            ...
            if(rows.length==0) res.status(401).send("sin resultados?");
                ...
                res.setHeader('Content-Disposition','attachment; filename="stoc.xlsx"');
...
module.exports={verificar_stoc,mostrar_stock}